...
import Liste from '../../../assets/img/liste'
            ...
            <SafeAreaView style={styles.page}>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', gap: 20 }}>
                    <TouchableOpacity onPress={() => navigation.navigate('Create4')} style={{ width: '45%' }}>
                        <Bouton texte={'Vue en Carte'} ImageComposent={Cart} block={{
                            marginBottom: 0,
                            gap: 10,
                            width: 150
                        }} />
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('3')} >
                        <Bouton block={styles.botton_back} text={styles.botton_text} texte={'Vue en Liste'} ImageComposent={Liste} />
                    </TouchableOpacity>
                </View>
