            ...
            <ScrollView style={{ width: '100%', }}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.buttons}>
                        <TouchableOpacity style={[styles.button, { borderColor: '#FFD17E', backgroundColor: '#FFEDCC', }]}>
                            <Premium />
                            <Text style={{ fontSize: 16, fontWeight: '700', color: '#020931', }}>Payer son abonnement</Text>
                        </TouchableOpacity>
