              ...
              > */}
                <View style={styles.tout}>
                  ...
                  <View style={styles.df7}>
                    ...
                    <View style={styles.dfb1}>
                        <TouchableOpacity style={styles.btb}>
                            <Text style={styles.tbtb}>Ajouter des photos</Text>
                            <Image style={styles.cavi} source={require('../../assets/ressource/ca.png')} />
                        </TouchableOpacity>
                    </View>
                  ...
                  <View style={styles.df8}>
                    ...
                    <View style={styles.dfb2}>
                        <TouchableOpacity style={styles.btb2}>
                            <Text style={styles.tbtb}>Ajouter des Vidéo</Text>
                            <Image style={styles.cavi} source={require('../../assets/ressource/vi.png')} />
                        </TouchableOpacity>
                    </View>
