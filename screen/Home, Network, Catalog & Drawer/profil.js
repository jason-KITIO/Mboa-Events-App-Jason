    ...
    return (
        ...
        <View style={styles.container}>
                    ...
                    <View style={styles.noms}>
                        <View style={styles.viewpremuim}>
                            ...
                            <View style={styles.premuim}>
                                <PremieumSvgComponent style={{ marginTop: 4 }} />
                                <Text style={[{ fontFamily: 'regular' }, styles.textemail]}>Premium</Text>
                            </View>
                        </View>
            ...
            <View style={styles.btn}>
                <View style={{ width: 358 }}>
                    <TouchableOpacity style={styles.btncree} onPress={() => navigation.navigate('CreateEventDesign')} >
                        <Text style={[{ fontFamily: 'regularBold' }, styles.textcree]}>Créer un évènement</Text>
                        <AddSvgComponent />
                    </TouchableOpacity>
                </View>
                <View style={{ width: 358 }}>
                    <TouchableOpacity style={styles.btnbuissiness} onPress={() => navigation.navigate('listeBusinessEmpty')}>
            ...
            <View style={styles.donne}>
                ...
                <View style={styles.donne1}>
                    ...
                    <TouchableOpacity style={styles.icontext} onPress={() => navigation.navigate('ChatDesign')}>
