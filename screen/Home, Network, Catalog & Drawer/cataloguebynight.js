            ...
            <View style={styles.contscrol}>
                <ScrollView contentContainerStyle={styles.scrollcontain}>
                    <View style={styles.ligne2}>
                        ...
                        <View>
                            <TouchableOpacity style={styles.voir} onPress={() => navigation.navigate('Boitedenuit')}>
                    ...
                    <View style={styles.ligne2}>
                        <View>
                            <Text style={[styles.textmis, { fontFamily: 'regularBold' }]}>Snacks Bars</Text>
                        </View>
                        <View>
                    ...
                    <View style={styles.ligne2}>
                        <View>
                            <Text style={[styles.textmis, { fontFamily: 'regularBold' }]}>Cave</Text>
                        </View>
                        <View>
                            <TouchableOpacity style={styles.voir}>
                                <Text style={[{ fontFamily: 'regularBold' }, styles.textvoir]}>Voir tout</Text>
                        ...
                        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} contentContainerStyle={styles.scrolhorizontal}>
                            <View style={styles.contelement2}>
                                <View style={styles.line1}>
                                    <View style={styles.nom}>
                                        <View style={styles.imageview}>
                                            <Image source={require('../../assets/component/Image/Oval (4).png')} style={styles.image} />
                                        </View>
                                ...
                                <View style={styles.line2}>
                                    <ImageBackground source={require('../../assets/component/Image/Image (7).png')} // Remplacez par le chemin de votre image
                                        style={styles.background}>
                    ...
                    <View style={styles.ligne2}>
                        <View>
                            <Text style={[styles.textmis, { fontFamily: 'regularBold' }]}>Boite de nuit</Text>
                        </View>
                        <View>
                            <TouchableOpacity style={styles.voir} onPress={() => navigation.navigate('Boitedenuit')}>
                                <Text style={[{ fontFamily: 'regularBold' }, styles.textvoir]}>Voir tout</Text>
...
module.exports = CatalogueByNight