            ...
            <View style={styles.column}>
                ...
                <View style={styles.sousPage}>
                        ...
                        <View style={styles.ordonne}>
                            ...
                            <View>
                                <View style={styles.absicce}>
                                    <Graph Bas={{ height: '80%', width: 60, backgroundColor: '#041578' }} text={'1800'} style_text={{ marginLeft: 18 }} />
                                    <Graph Bas={{ height: '70%', width: 60, backgroundColor: '#6D77B1' }} text={'1400'} style_text={{ marginLeft: 18 }} />
                                </View>
                    ...
                    <TouchableOpacity style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 20 }} onPress={() => navigation.navigate('List_of_participants')}>
                        ...
                        <Text style={{ position: 'relative', right: 22, fontWeight: 700, width: '50%' }} numberOfLines={1} ellipsizeMode="tail">+ 20 personnes participent</Text>
                    </TouchableOpacity>
                </View>
            </View>
