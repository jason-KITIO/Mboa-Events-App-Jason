...
const CreateEventDesign = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <StatusBar
                ...
                translucent={false}
            />
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 20, backgroundColor: '#fff', paddingVertical: 10, borderColor: '#041578', borderBottomWidth: 1 }}>
                ...
                <View style={styles.form}>
                    ...
                    <View style={styles.textInput}>
                        ...
                        <View style={{
                            ...
                            <Inputs
                                ...
                                icon={<Calendar />}
                                onPress={() => navigation.navigate('CreateEventDesign4')}
                            />
                            <Inputs
                    ...
                    <View style={styles.textInput}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity style={[styles.button, { backgroundColor: '#F2F2F2', }]} onPress={() => navigation.navigate('CreateEventDesign3')}>
                                <Payant />
                                <Text>Payant</Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    <View style={styles.textInput}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity style={[styles.button, { backgroundColor: '#F2F2F2', }]} onPress={() => navigation.navigate('CreateEventDesign2')}>
                                <Text>Oui</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
...
module.exports = CreateEventDesign