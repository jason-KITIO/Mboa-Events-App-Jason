...
const CreateEventDesign3 = ({ navigation }) => {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={{ marginTop: 40, }}>
                    <TouchableOpacity style={styles.valid} onPress={() => navigation.navigate('CreateEventDesign4')}>
...
module.exports = CreateEventDesign3