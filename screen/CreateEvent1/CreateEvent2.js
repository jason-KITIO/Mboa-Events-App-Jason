...
const CreateEventDesign2 = ({ navigation }) => {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.form}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('CreateEventDesign4')} style={styles.textInput}>
                    ...
                    <View style={styles.textInput}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity style={[styles.button, { backgroundColor: '#041578', }]}>
                                <Text style={{ color: '#ffffff', }}>Oui</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    <View style={styles.textInput}>
                        <Text style={styles.label}>Charger la ou les photos du menu</Text>
                        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                            <View
                                style={{
                                    flexDirection: 'row',
...
module.exports = CreateEventDesign2