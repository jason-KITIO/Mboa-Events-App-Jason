    ...
    return (
        <View style={styles.container}>
            <StatusBar
                ...
                translucent={false}
            />
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 30, backgroundColor: '#fff', paddingVertical: 10, paddingVertical: 10, borderColor: '#041578', borderBottomWidth: 1 }}>
                ...
                <Text style={{ color: '#041578', fontSize: 20, fontWeight: '600' }}>Akono Frill</Text>
            </View>
            <ScrollView
                style={{
                    marginTop: 10,
