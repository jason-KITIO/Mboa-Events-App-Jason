...
function Statistique({ navigation },) {
    ...
    return (
        <View>
            <ScrollView showsVerticalScrollIndicator={false}>
                <SafeAreaView style={styles.page}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', width: '90%', gap: 10 }}>
                        ...
                        />
                        <Button_1 />
                        <TouchableOpacity onPress={() => navigation.navigate('Event_Search_Events_04')}>
                            <Sort />
                        </TouchableOpacity>
                    </View>
                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <View style={{ display: 'flex', flexDirection: 'row' }}>
                            <Text style={[styles.texteSimple, { color: '#020931', fontSize: 14 }]}>Total: </Text>
                            <Text style={[styles.texteBold, { color: '#020931', fontSize: 14 }]}>83</Text>
                        </View>
                    </View>
                    <View style={{
                        display: 'flex',
            ...
            <View style={{ position: 'absolute', zIndex: 3, bottom: 10, right: 10 }}>
                <Button1 />
            </View>
        </View>
    );
