...
function Statistique({ navigation },) {
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={{ backgroundColor: '#1E2448', height: 150 }}>
                <View style={{marginTop: 35, marginLeft: 16}}>
                    <Text style={[styles.texteSimple, {color: '#fff'}]}>Bienvenue dans votre</Text>
                    <Text style={[styles.texteSimple, {color: '#fff'}]}>Tableau de bord</Text>
                    <Text style={[styles.texteBold, {color: '#FFD17E'}]}>Stéphane Ndiki</Text>
                </View>
                <View>
                    <Image
