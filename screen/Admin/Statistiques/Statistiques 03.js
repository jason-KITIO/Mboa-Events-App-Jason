            ...
            <SafeAreaView style={styles.page}>
                <View style={styles.haut}>
                    ...
                    <View style={styles.gauche}>
                        <Text style={styles.gauche_text}>Utilisateurs</Text>
                        <View style={styles.boton}></View>
                    </View>
                    <TouchableOpacity style={styles.droite} onPress={() => navigation.navigate('Statistiques_04')}>
                ...
                <View style={styles.graph}>
                    ...
                    <View style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end', flexDirection: 'row', gap: 20, marginBottom: 20 }}>
                        <View>
                            <Text style={{ color: '#041578' }}>Utilisateurs Freemium</Text>
                            <Text style={{ fontSize: 20, fontWeight: '700' }}>1024</Text>
                        </View>
                        <View>
                            <Text style={{ color: '#F47A0D' }}>Utilisateurs Premium</Text>
                            <Text style={{ fontSize: 20, fontWeight: '700' }}>450</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.graph}>
                    ...
                    <View style={styles.ordonne}>
                        ...
                        <View>
                            <View style={styles.absicce}>
                                <Graph Haut={{ height: '60%', backgroundColor: '#041578' }} text={'20%'} />
                                <Graph Haut={{ height: '40%', backgroundColor: '#041578' }} text={'48%'} />
                                <Graph Haut={{ height: '20%', backgroundColor: '#041578' }} text={'78%'} />
                                <Graph Haut={{ height: '55%', backgroundColor: '#041578' }} text={'14%'} />
                                <Graph Haut={{ height: '85%', backgroundColor: '#041578' }} text={'14%'} />
                            </View>
