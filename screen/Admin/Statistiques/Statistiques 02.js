        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <SafeAreaView style={styles.page}>
                <View style={styles.haut}>
                    ...
                    <TouchableOpacity style={styles.droite} onPress={() => navigation.navigate('Statistiques_03')}>
                    ...
                    <View style={styles.ordonne}>
                        ...
                        <View>
                            ...
                            <View style={styles.Block_mois}>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Jan</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Fev</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Mar</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Avr</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Mai</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Jun</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Jui</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Aou</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Sep</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Oct</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Nov</Text>
                                <Text style={styles.mois} numberOfLines={1} ellipsizeMode="tail">Dec</Text>
                            </View>
                        </View>
                    </View>
                </View>
