    ...
    return (
        <View style={{ height: '100%', backgroundColor: '#fff' }}>
                    ...
                    <View style={styles.Historique_Photo_More}>
                            ...
                            <View style={styles.pickerContainer}>
                                <TouchableOpacity onPress={toggleFilters}>
                                    <View style={{ display: 'flex', flexDirection: 'row', backgroundColor: '#F5F5F6', padding: 16, gap: 16, borderRadius: 8, justifyContent: 'space-between' }}>
                                        <Text style={[styles.texteSimple, { fontSize: 14, color: '#767A90' }]}>2023</Text>
                                        <FlecheBas />
                                    </View>
                                </TouchableOpacity>
                            </View>
                        ...
                        <View style={styles.column}>
                            ...
                            <View style={styles.pickerContainer}>
                                <TouchableOpacity onPress={toggleFilters}>
                                    <View style={{ display: 'flex', flexDirection: 'row', backgroundColor: '#F5F5F6', padding: 16, gap: 16, borderRadius: 8, justifyContent: 'space-between' }}>
                                        <Text style={[styles.texteSimple, { fontSize: 14, color: '#767A90' }]}>Douala</Text>
                                        <FlecheBas />
                                    </View>
                                </TouchableOpacity>
                            </View>
                        ...
                        <View style={styles.column}>
                            <Text style={styles.titre}>Mois</Text>
                            <View style={styles.pickerContainer}>
                                <TouchableOpacity onPress={toggleFilters}>
                                    <View style={{ display: 'flex', flexDirection: 'row', backgroundColor: '#F5F5F6', padding: 16, gap: 16, borderRadius: 8, justifyContent: 'space-between' }}>
                                        <Text style={[styles.texteSimple, { fontSize: 14, color: '#767A90' }]}>janvier 2023</Text>
                                        <FlecheBas />
                                    </View>
                                </TouchableOpacity>
                            </View>
            ...
            <View style={{ position: 'absolute', bottom: 0, backgroundColor: '#fff', width: '100%' }}>
                <View style={{ display: 'flex', flexDirection: 'row', gap: 30, paddingLeft: 10 }}>
