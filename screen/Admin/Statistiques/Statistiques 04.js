            ...
            <SafeAreaView style={styles.page}>
                <View style={styles.haut}>
                    <TouchableOpacity style={styles.droite} onPress={() => navigation.navigate('Statistiques_02')}>
                        <Text style={styles.droite_text}>Évènements </Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.droite} onPress={() => navigation.navigate('Statistiques_05')}>
                        <Text style={styles.droite_text}>Utilisateurs</Text>
                    </TouchableOpacity>
                    <View style={styles.gauche}>
                        <Text style={styles.gauche_text}>Finances</Text>
                        <View style={styles.boton}></View>
                    </View>
                </View>

                <Text style={styles.Titre}>Montant total généré par les abonnements Premium et Partenaires  par ville</Text>
                <View style={styles.graph}>
                    ...
                    <View style={styles.ordonne}>
                        ...
                        <View>
                            <View style={styles.absicce}>
                                ...
                                <Graph Haut={{ height: '40%', }} Bas={{ height: '60%', }} text={'78%'} />
                                <Graph Haut={{ height: '55%', }} Bas={{ height: '15%', }} text={'14%'} />
                    ...
                    <View style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end', flexDirection: 'row', gap: 20, marginBottom: 20 }}>
                        <View>
                            <Text style={{ color: '#041578' }}>Partenaires</Text>
                            <View style={{ display: 'flex', flexDirection: 'row', gap: 5 }}>
                                <Text style={{ fontSize: 20, fontWeight: '700' }}>125k</Text>
                                <Text style={{ fontSize: 16, fontWeight: '700' }}>FCFA</Text>
                            </View>
                        </View>
                        <View>
                            <Text style={{ color: '#F47A0D' }}>Abonnements Premium</Text>
                            <View style={{ display: 'flex', flexDirection: 'row', gap: 5 }}>
                                <Text style={{ fontSize: 20, fontWeight: '700' }}>450k</Text>
                                <Text style={{ fontSize: 16, fontWeight: '700' }}>FCFA</Text>
                            </View>
                        </View>
                    </View>
                </View>
                <Text style={styles.Titre}>Montant total généré par les publicités par ville</Text>
                <View style={styles.graph}>
                    ...
                    <View style={styles.ordonne}>
                        ...
                        <View>
                            <View style={styles.absicce}>
                                <Graph Haut={{ height: '50%', backgroundColor: '#9B51E0' }} text={'20%'} />
                                <Graph Haut={{ height: '60%', backgroundColor: '#9B51E0' }} text={'48%'} />
                                <Graph Haut={{ height: '70%', backgroundColor: '#9B51E0' }} text={'78%'} />
                                <Graph Haut={{ height: '58%', backgroundColor: '#9B51E0' }} text={'14%'} />
                                <Graph Haut={{ height: '40%', backgroundColor: '#9B51E0' }} text={'20%'} />
                                <Graph Haut={{ height: '20%', backgroundColor: '#9B51E0' }} text={'45%'} />
                                <Graph Haut={{ height: '23%', backgroundColor: '#9B51E0' }} text={'12%'} />
                            </View>
                    ...
                    <View style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end', flexDirection: 'row', gap: 20, marginBottom: 20 }}>
                        <View>
                            <Text style={{ color: '#9B51E0' }}>Total publicités</Text>
                            <View style={{ display: 'flex', flexDirection: 'row', gap: 5 }}>
                                <Text style={{ fontSize: 20, fontWeight: '700' }}>125k</Text>
                                <Text style={{ fontSize: 16, fontWeight: '700' }}>FCFA</Text>
                            </View>
