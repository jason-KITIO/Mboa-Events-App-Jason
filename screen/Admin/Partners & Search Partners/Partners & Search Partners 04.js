...
import Calendier from '../../../assets/img/calendier'
import Tel from '../../../assets/img/tel1'
            ...
            <View style={styles.column}>
                ...
                <View style={styles.sousPage}>
                    ...
                    <View style={{
                        ...
                        <Text style={styles.titre_Bold}>Info</Text>
                        <View style={{ display: 'flex', flexDirection: 'row', gap: 10 }}>
                            <View style={{ backgroundColor: '#E6E8F2', borderRadius: 50, padding: 10, width: 35 }}>
                                <Calendier />
                            </View>
                            <View>
                                <Text>Email</Text>
                                <Text style={{ fontWeight: '700' }}>Clubo@gmail.com</Text>
                            </View>
                        </View>
                        <View style={{ height: 1, backgroundColor: '#DEDFE4' }}></View>
                        <View style={{ display: 'flex', flexDirection: 'row', gap: 10 }}>
                            <View style={{ backgroundColor: '#E6E8F2', borderRadius: 50, padding: 10, width: 35 }}>
                                <Tel />
                            </View>
                            <View>
                                <Text>Téléphone</Text>
                                <Text style={{ fontWeight: '700' }}>+237 698 785 458</Text>
                            </View>
                        </View>
                    </View>
