...
import Juste from '../../assets/img/juste4'

import RadioButton from './RadioButton'
import Bouton1 from './bouton1'

const CustomTextInput = ({ pp, like, commentaire, send, container1, nom, Nom_style, show_details, show_not_details }) => {
    return (
