        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={{ marginTop: 40, }}>
                    <TouchableOpacity style={styles.valid} onPress={() => navigation.navigate('EditeEventSave')}>
                        <Text style={{ color: '#ffffff', fontSize: 16, fontWeight: '700', }}>Sauvegarder l'évènement</Text>
                    </TouchableOpacity>
                </View>
